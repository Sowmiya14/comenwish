            ...
            <div class="login-container animated fadeInRightBig">
                ...
                <form class="form-horizontal" method="POST" action="{{ url('/vendor/login') }}">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="email" id="inputEmail3" placeholder="Email or Username" value="{{ old('email') }}" autofocus>
                    ...
                    <div class="form-group">
                        <div class="flexbox align-items-center">
                            ...
                            <a href="{{ url('/vendor/password/reset') }}" data-toggle="tooltip" class="theme-cl" data-original-title="Forgot Password">Forgot Password?</a>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="flexbox align-items-center">
                            ...
                            <p>If You Are a New User <a href="{{ url('vendor/register') }}" data-toggle="tooltip" class="gredient-cl" data-original-title="Sign Up">Signup Here.</a></p>
                        </div>
                    </div>
