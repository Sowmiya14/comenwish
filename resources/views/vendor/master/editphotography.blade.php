...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-12 align-self-center">
            <h4 class="theme-cl">Edit photography</h4>
        </div>
    </div>
    <!-- Title & Breadcrumbs-->
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form data-toggle="validator" class="padd-20" action="{{route('vendor.update_photography', $data->id)}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row mrg-0">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $data->typeofphotography}}" name="typeofphotography" required="" id="inputName" data-error="Please Enter Type of Photography"  >
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $data->styleofshoot }}" name="styleofshoot" required="" id="inputName" data-error="Please Enter Style of Shoot"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $data->typeofshoot }}" name="typeofshoot" required="" id="inputName" data-error="Please Enter Type of Shoot"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $data->photoalbum}}" name="photoalbum" required="" id="inputName" data-error="Please Enter Photo Album"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" value="{{ $data->productimageupload }}" name="productimageupload[]" multiple required="" id="inputName" aria-describedby="fileHelp">
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="text-center">
                                    <button type="submit" class="btn gredient-btn"> Update Photography</button>
                                </div>
                            </div>
                        </div>
