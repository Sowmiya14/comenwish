...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-6 align-self-center">
            <h4 class="theme-cl">Gift Compliments</h4>
        </div>
        <div class="col-md-6 align-self-center">
            <div class="text-center pull-right">
                <a href="{{ url('/vendor/master/viewgift') }}" ><button type="button" class="btn gredient-btn">View Gifts</button></a>
            </div>
        </div>
    </div>
    <!-- Title & Breadcrumbs-->
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="typeofgift" id="inputName" data-error="Please Enter Type of Gift"  >
