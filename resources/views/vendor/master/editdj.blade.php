...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-12 align-self-center">
            <h4 class="theme-cl">Edit DJ Master</h4>
        </div>
    </div>
    <!-- Title & Breadcrumbs-->
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form class="padd-20" action="{{route('vendor.update_dj', $data->id)}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}

                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputName" class="control-label">Type of DJ</label>
                                <input type="text" class="form-control" value="{{ $data->typeofdj }}" name="typeofdj" required="" id="inputName" data-error="Please Enter Type of DJ"  >
                       ...
                       <!--  <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $data->budgetlimit }}" name="budgetlimit" required="" id="inputName" data-error="Please Enter Budget Limit"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div> -->
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="text-center">
                                    <button type="submit" class="btn gredient-btn">Update DJ</button>
                                </div>
                            </div>
                        </div>
                    </div>
