...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-6 align-self-center">
            <h4 class="theme-cl">Groomings</h4>
        </div>
        <div class="col-md-6 align-self-center">
            ...
            <table class="table table-striped table-hover">
                ...
                @foreach($datas as $data)
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('vendor.destory_grooming', $data->id) }}" method="POST">
                                {{ csrf_field() }}
                                <input type="hidden" name="_method" value="DELETE">
                                <a href="{{route('vendor.edit_grooming',$data->id)}}" class="btn btn-info"><i class="fa fa-pencil"></i></a>
