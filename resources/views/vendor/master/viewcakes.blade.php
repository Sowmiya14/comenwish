            ...
            <table class="table table-striped table-hover">
                ...
                @foreach($datas as $data)
                    ...
                    <tr>
                        ...
                        <td>{{ $data->typeofcake }}</td>
                        <td>{{ $data->producttitle }}</td>
                        <td>{{ $data->productdescription }}</td>
                        <td>{{ $data->productprice   }}</td>
                        <td>{{ $data->servicecharge }}</td>
                        <td>
                            <form action="{{ route('vendor.destory_cakes', $data->id) }}" method="POST">
                                {{ csrf_field() }}
                                <input type="hidden" name="_method" value="DELETE">
                                <a href="{{route('vendor.edit_cakes',$data->id)}}" class="btn btn-info"><i class="fa fa-pencil"></i></a>
