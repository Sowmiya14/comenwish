...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-6 align-self-center">
            <h4 class="theme-cl">Sangeeth Choreo Graphers Master</h4>
        </div>
        <div class="col-md-6 align-self-center">
            <div class="text-center pull-right">
                <a href="{{ url('/vendor/master/viewchoreo') }}" ><button type="button" class="btn gredient-btn">View Sangeeth Choreo Graphers</button></a>
            </div>
        </div>
    </div>
    <!-- Title & Breadcrumbs-->
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="typeofchoreography" id="inputName" data-error="Please Enter Type of Choreography"  >
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="typeofperformence" id="inputName" data-error="Please Enter Type of Performence"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
