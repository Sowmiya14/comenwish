...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-12 align-self-center">
            <h4 class="theme-cl">Edit Sangeeth Choreo Graphers Master</h4>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form data-toggle="validator" class="padd-20" action="{{route('vendor.update_choreo', $data->id)}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputName" class="control-label">Type of Choreography</label>
                                <input type="text" class="form-control" value="{{ $data->typeofchoreography }}" name="typeofchoreography" required="" id="inputName" data-error="Please Enter Type of Choreography"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputName" class="control-label">Type of Performence</label>
                                <input type="text" class="form-control" value="{{ $data->typeofperformence }}" name="typeofperformence" required="" id="inputName" data-error="Please Enter Type of Performence"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="text-center">
                                    <button type="submit" class="btn gredient-btn">Update Choreographers</button>
                                </div>
                            </div>
                        </div>
                    </div>
