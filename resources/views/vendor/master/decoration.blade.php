...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-6 align-self-center">
            <h4 class="theme-cl">Decoration Master</h4>
        </div>
        <div class="col-md-6 align-self-center">
            <div class="text-center pull-right">
                <a href="{{ url('/vendor/master/viewdecoration') }}" ><button type="button" class="btn gredient-btn">View Decorations</button></a>
            </div>
        </div>
    </div>
    <!-- Title & Breadcrumbs-->
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputName" class="control-label"><span class="asterisk"></span>Type of Decoration</label>
                                <input type="text" class="form-control" name="typeofdecoration" id="inputName" data-error="Please Enter Type of decoration"  >
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="serviceablebudget" id="inputName" data-error="Please Enter Serviceable Budget"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="serviceabledecoration" id="inputName" data-error="Please Enter Serviceable Decoration"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
