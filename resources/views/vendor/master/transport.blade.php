    ...
    <div class="row page-titles">
        ...
        <div class="col-md-6 align-self-center">
            <div class="text-center pull-right">
                <a href="{{ url('/vendor/master/viewtransport') }}" ><button type="button" class="btn gredient-btn">View Transport</button></a>
            </div>
        </div>
    </div>
    <!-- Title & Breadcrumbs-->
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="serviceablelocation" id="inputName" data-error="Please Enter Serviceable Location"  >
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="typeoftransport" id="inputName" data-error="Please Enter Type of Transport"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="typeofcomfort" id="inputName" data-error="Please Enter Type of Comfort"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="typeofvehicle" id="inputName" data-error="Please Enter Type of Vehicle"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="typeofsubcategory" id="inputName" data-error="Please Enter Type of Subcategory"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                         <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="typeofdrive" id="inputName" data-error="Please Enter Type of Drive"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
