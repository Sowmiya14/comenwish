...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-6 align-self-center">
            <h4 class="theme-cl">Videography Master</h4>
        </div>
        <div class="col-md-6 align-self-center">
            <div class="text-center pull-right">
                <a href="{{ url('/vendor/master/viewvideography') }}" ><button type="button" class="btn gredient-btn">View Videography</button></a>
            </div>
        </div>
    </div>
    <!-- Title & Breadcrumbs-->
                ...
                {{csrf_field()}}
                    ...
                    <div class="row mrg-0">
                     <div class="col-sm-6">
                         <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="typeofvideography" id="inputName" data-error="Please Enter Type of Videography"  >
                  ...
                  <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="inputName" name="productimageupload[]" multiple aria-describedby="fileHelp">
