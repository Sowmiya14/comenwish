...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <form data-toggle="validator" class="padd-20" method="post" action="{{ route('admin.update_vendor',$editvendor->id) }}" enctype="multipart/form-data">
                <div class="card">
                    {{ csrf_field() }}
                    <div class="row page-titles">
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-only" name="ownername"  value="{{$editvendor->ownername}}"  required="" >
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="email" value="{{$editvendor->email}}"   class="form-control" name="email" id="inputphone" required="" readonly="" >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mrg-0">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="tel" id="mobilenumber" name="mobilenumber" class="form-control phone" onkeypress="return isNumberKey(event)" value="{{$editvendor->mobilenumber}}" maxlength="15" readonly/>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="profilepicture"  class="form-control-file" id="inputName" aria-describedby="fileHelp" value="{{$editvendor->profilepicture}}"  multiple>
                            </div>
                        </div>
                    </div>
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="contactpersonname1" class="form-control text-only"  value="{{$editvendor->contactpersonname1}}"  required="">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="tel" id="contactpersonmobileno1" name="contactpersonmobileno1" class="form-control phone" onkeypress="return isNumberKey(event)" value="{{$editvendor->contactpersonmobileno1}}" maxlength="15" />
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mrg-0">
                         <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="contactpersonname2" class="form-control text-only"  value="{{ $editvendor->contactpersonname2 }}" >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                         <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="tel" id="contactpersonmobileno2" name="contactpersonmobileno2" class="form-control phone" onkeypress="return isNumberKey(event)" value="{{$editvendor->contactpersonmobileno2}}" maxlength="15" />
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-only" name="businessname" id="inputName"  data-error="Please Enter Business Name" value="{{ $editvendor->businessname }}"  required="" minlength="3" maxlength="15"/>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                       ...
                       <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="businesslogo" value="{{ $editvendor->businesslogo }}"  class="form-control-file" id="inputName" aria-describedby="fileHelp">
                            </div>
                        </div>
                   </div>
                    <div class="row mrg-0">
                    ...
                    <div class="col-sm-6">                           
                        ...
                        <input type="text" class="form-control" id="inputEmail"name="gstnumber" data-
                        error="Please Enter GST Number" required="" value="{{ $editvendor->gstnumber
                        }}" maxlength="15"/>                                    <div class="help-block
                        with-errors"></div> 
                    </div>
                    </div>                     
                </div>                    
