...
@section('content')
    ...
    <div class="row hideall" id="div14">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form class="padd-20" action="{{route('admin.showBridalWear')}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
                    ...
                    <div class="row mrg-0">
                        ...
                        @include('admin.layout.ratevariation')
    ...
    <div class="row hideall" id="div13">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form data-toggle="validator" class="padd-20" action="{{route('admin.showGifts')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
  ...
  {{--Venues--}}
    ...
    <div class="row hideall" id="div1">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form class="padd-20" action="{{route('admin.showVenues')}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
                    ...
                    <div class="row mrg-0">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control number-only" name="stagedimensions" id="inputName" data-error="Please Enter Stage Dimensions"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control number-only" name="seatingcapacity" id="inputName" data-error="Please Enter Service Charge"  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
    ...
    <div class="row hideall" id="div2">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form class="padd-20" action="{{route('admin.showCaterings')}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
                    ...
                    <div class="row mrg-0">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea name="menu" class="form-control text-only" id="inputName" cols="30" rows="5"></textarea>
    ...
    <div class="row hideall" id="div3">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form data-toggle="validator" class="padd-20" action="{{route('admin.showPhotography')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
         ...
         <div class="help-block with-errors"></div>
                        ...
                        <!-- div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputName" class="control-label"><span class="asterisk">Type of Photography</span></label>
                                <input type="text" class="form-control"name="typeofphotography" id="inputName" data-error="Please Enter Type of Photography" required=""  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div> -->
    ...
    <div class="row hideall" id="div4">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form class="padd-20" action="{{route('admin.showVideoGraphy')}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
        ...
        <div class="row mrg-0"> 
         ...
         <div class="help-block with-errors"></div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputName" class="control-label"><span class="asterisk">Service Charge</span></label>
                                <input type="text" class="form-control" name="servicecharge" id="inputName" data-error="Please Enter Service Charge" required="" >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
    ...
    <div class="row hideall" id="div5">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form data-toggle="validator" class="padd-20" method="post" action="{{route('admin.showMakeUp')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
    ...
    <div class="row hideall" id="div6">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form data-toggle="validator" class="padd-20" action="{{route('admin.showGrooming')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
    ...
    <div class="row hideall" id="div7">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form class="padd-20" action="{{route('admin.showDecoration')}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
    ...
    <div class="row hideall" id="div8">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form class="padd-20" action="{{route('admin.showDj')}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
 ...
 <div class="row mrg-0"> 
    ...
    <div class="row hideall" id="div9">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form data-toggle="validator" class="padd-20" action="{{route('admin.showChoreo')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
   ...
   @include('admin.layout.users')
            ...
            <div class="col-sm-6">
               <div class="form-group">
           <label for="inputName" class="control-label"><span class="asterisk">Type of Choreographers</span></label>
    ...
    <div class="row hideall" id="div10">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form data-toggle="validator" class="padd-20" method="post" action="{{route('admin.showMusic')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
    ...
    <div class="row hideall" id="div12">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form data-toggle="validator" class="padd-20" method="post" action="{{route('admin.addtransport')}}" enctype="multipart/form-data" >
                    {{ csrf_field() }}
                           ...
                           <div class="row mrg-0">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="serviceablelocation" id="inputName" data-error="Please Enter Serviceable Location" required="" >
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
    ...
    <div class="row hideall" id="div11">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form data-toggle="validator" class="padd-20" method="post" action="{{route('admin.showCakes')}}"  enctype="multipart/form-data">
                    {{ csrf_field() }}
         ...
         <div class="help-block with-errors"></div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cakesize" required="">
                                    <option>Select</option>
                                    @for ($i = 1; $i <= 12; $i++)
                                       <option value="{{ $i*0.5}}">{{ $i*0.5}}kg</option>
                                    @endfor
                                </select>
 ...
 -->
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ratevariationpercentage" id="inputName" data-error="Please Enter Rate Variation Percentage Name" required=""  >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
